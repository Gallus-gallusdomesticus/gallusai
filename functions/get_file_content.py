...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Read file content in the specified file path with maximum 10000 characters, constrained to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The file path needed to read the file from, relative to the working directory.",
            ),
        },
    ),
)